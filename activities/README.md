# Activities for Artificial Intelligence (AI)
For a full list of the different activities for the AI class, please check Brightspace and the due dates for each specific activity.

---

## Activity #1 — AI Foundations Briefing
**Sessions 1–3** | Tools: PowerPoint, Video
- [README](Activity1/README.md)
- [Company Brief](Activity1/A1_CompanyBrief.md)
- [Presentation Guide](Activity1/A1_PresentationGuide.md)

## Activity #2 — Development Environment Setup
Tools: Anaconda, conda, Python, JupyterLab
- [README](Activity2/README.md)
- [Setup Guide](Activity2/A2_SetupGuide.md)

## Activity #3 — AI Applications & Ethics Briefing
**Sessions 4–5** | Tools: PowerPoint, Video
- [README](Activity3/README.md)
- [Domain Options](Activity3/A3_DomainOptions.md)
- [Presentation Guide](Activity3/A3_PresentationGuide.md)

## Activity #4 — Python Code Comprehension Lab
**Session 6** | Tools: Python, JupyterLab
- [README](Activity4/README.md)
